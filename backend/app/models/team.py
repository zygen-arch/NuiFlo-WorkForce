...
from sqlalchemy import Column, Integer, String, Text, Numeric, DateTime, Enum as SQLEnum, ForeignKey
...
class Team(Base):
    ...
    # Space relationship
    space_id = Column(String(50), ForeignKey("team_spaces.id"), nullable=True)  # Will be NOT NULL after migration
